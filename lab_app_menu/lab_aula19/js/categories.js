...
class Categories {
    ...
    /*
        função que retorna a relação de códigos de categorias existentes
        @categoryList -- tipo array
    */
    listCat() {
